...
def redirect_stdout_to_file():
    ...
    # quando redirect_output=False na função setup_logging
    print("Logs sendo mostrados diretamente no terminal")
...
def setup_logging(console_level: int = DEFAULT_LOG_LEVEL, 
    ...
    # Console handler para mostrar TODOS os níveis de log no console
    console_handler = logging.StreamHandler(sys.stdout)
    console_handler.setLevel(console_level)  # Usa o nível de console configurado
    
    # Removemos o filtro para permitir que todas as mensagens apareçam no console
    # de acordo com o nível configurado
